...
<body>
	...
	<div id="mainContainer">
		...
		<div id="identifyEmail">
	        ...
	        <form action="registerEmail.do" method="post" id="identifyEmailForm">
	            ...
	            <img src="${pageContext.request.contextPath }/resources/svg/line.svg"/>
    ...
    $(document).ready(function() {
    	  ...
    	  $(".btn").on("click", function(e) {
    	    ...
    	    if (!box1Checked || !box2Checked) {
    	      ...
    	      $(this).attr("href", "${pageContext.request.contextPath }/member/memberRegister");
    	    }
    	  });
    	});
    ...
    $("#checkEmailBtn").on("click", function(event) {
        ...
        $.ajax({
            url: "${pageContext.request.contextPath }/email/registerEmail",
            type: "POST",
            ...
            success: function(result) {
                if (result == 0) {
                    ...
                    $("#emailIdentiBtn").on("click", function(event) {
                        ...
                        $.ajax({
                            url: "${pageContext.request.contextPath }/email/checkEmail",
                            type: "POST",
