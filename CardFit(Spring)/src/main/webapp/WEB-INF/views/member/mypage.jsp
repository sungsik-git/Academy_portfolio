...
<body>
	<c:import url="../../../resources/header/header.jsp" />
		<article>
 		<c:import url="../../../resources/myPageMenu/myPageMenu.jsp"/>
		<section>
			<c:choose>
					...
					<div class="issuingContainer">
						...
						<div id="issuingComents">
							...
							<c:if test="${fn:length(issuanceInfo) >=2 }">
								<div id="goIssuance"><a class="issuanceMenu">내 카드가 ${fn:length(issuanceInfo)-1  }건 더 있어요! 자세히 보러가기 click!</a></div>
							</c:if>
						</div>
					</div>
				</c:when>
	...
	$(function() {
		  $('.issuanceMenu').on('click', function(event) {
		    ...
		    if (cachedData) {
		      ...
		      $.ajax({
		        url: '${pageContext.request.contextPath }/member/memberIssuance',
		        type: 'GET',
		        dataType: 'html',
		  ...
		  $('#memberModifyMenu').on('click', function(event) {
		    ...
		    if (cachedData) {
		      ...
		      $.ajax({
		        url: '${pageContext.request.contextPath }/member/memberModify',
		        type: 'GET',
		        dataType: 'html',
		        success: function(response) {
		          $('#changeAjaxContainer').html(response).show();
		  ...
		  $('#changePWMenu').on('click', function(event) {
			    ...
			    if (cachedData) {
			      ...
			      $.ajax({
			        url: '${pageContext.request.contextPath }/member/memberChangePW',
			        type: 'GET',
			        dataType: 'html',
			        success: function(response) {
			          $('#changeAjaxContainer').html(response).show();
		  ...
		  $('#deleteInfoMenu').on('click', function(event) {
			    ...
			    if (cachedData) {
			      ...
			      $.ajax({
			        url: '${pageContext.request.contextPath }/member/memberDeleteInfo',
			        type: 'GET',
			        dataType: 'html',
			        success: function(response) {
			          $('#changeAjaxContainer').html(response).show();
		  ...
		  $('#helpNoticeMenu').on('click', function(event) {
			    ...
			    if (cachedData) {
			      ...
			      $.ajax({
			        url: '${pageContext.request.contextPath }/member/helpNotice',
			        type: 'GET',
			        dataType: 'html',
			        success: function(response) {
			          $('#changeAjaxContainer').html(response).show();
		  ...
		  $('#helpQNAMenu').on('click', function(event) {
			    ...
			    if (cachedData) {
			      ...
			      $.ajax({
			        url: '${pageContext.request.contextPath }/member/helpQNA',
			        type: 'GET',
			        dataType: 'html',
			        success: function(response) {
			          $('#changeAjaxContainer').html(response).show();
		  ...
		  $('#helpDirectMenu').on('click', function(event) {
			    ...
			    if (cachedData) {
			      ...
			      $.ajax({
			        url: '${pageContext.request.contextPath }/member/helpDirect',
			        type: 'GET',
			        dataType: 'html',
			        success: function(response) {
			          $('#changeAjaxContainer').html(response).show();
