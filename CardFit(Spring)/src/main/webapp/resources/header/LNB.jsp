...
<body>
	...
	<nav id="LNB">
		<ul>
			<li><img alt="" src="${pageContext.request.contextPath }/resources/svg/bar.svg"></li>
			<li><img alt="" src="${pageContext.request.contextPath }/resources/svg/search.svg" id="searchicon"></li>
			<c:if test="${sessionScope.id eq null}">
				<li><a href="${pageContext.request.contextPath }/member/login">
				<img alt="" src="${pageContext.request.contextPath }/resources/svg/user.svg"></a></li>
			</c:if>
			...
			<li>
				<c:if test="${sessionScope.id eq null}">
					...
					<img alt="" src="${pageContext.request.contextPath }/resources/svg/Login.svg"></a><br>
				</c:if> 
				<c:if test="${sessionScope.id ne null}">
					<a href="${pageContext.request.contextPath }/member/logout"><img alt="" src="${pageContext.request.contextPath }/resources/svg/Logout.svg"></a><br>
				</c:if>
			</li>
		</ul> 
	</nav>
