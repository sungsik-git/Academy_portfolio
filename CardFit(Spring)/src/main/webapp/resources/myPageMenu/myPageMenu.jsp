...
<link href="${pageContext.request.contextPath }/resources/css/member/myPageMenu.css" type="text/css" rel="stylesheet">
...
<body>
	<img alt="backgroundIMG" src="${pageContext.request.contextPath }/resources/svg/MyPage_Bg.svg" id="backImg">
