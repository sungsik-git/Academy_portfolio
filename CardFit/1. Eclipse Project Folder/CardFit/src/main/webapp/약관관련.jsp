...
<body>
    <div>
        <c:import url="./element/Logo/Logo.jsp"></c:import>
    </div>
    <div id="line">
        <div class="point">
            <p>약관동의</p>
    ...
    <div id="conditions1">
        <input type="checkbox" id="box1" onclick="is_checked()">카드핏 약관 동의(필수)
        <div id="contents1">
            <pre>
여러분을 환영합니다.
...
네이버 서비스와 관련하여 궁금하신 사항이 있으시면 고객센터(대표번호: 1588 – 3820/ 평일 09:00~18:00)로 문의 주시기 바랍니다.
    ...
    <div id="conditions2">
        <input type="checkbox" id="box2" onclick="is_checked()">개인정보 수집 및 이용 동의(필수)
        <div id="contents2">
            <pre>
...
이용자는 개인정보의 수집 및 이용 동의를 거부할 권리가 있습니다. 회원가입 시 수집하는 최소한의 개인정보, 즉, 필수 항목에 대한 수집 및 이용 동의를 거부하실 경우, 회원가입이 어려울 수 있습니다.                
    ...
    <div id="allCheck">
        <input type="button" value="다음단계로 이동" id="nextBtn1">
    </div>
</div>
<div id="identificationBox">
    <div id="identiPhone">
        이메일인증
        <form action="registerEmail.do" method="post">
            이메일을 입력하세요 <input type="email" id="registerEmail" name="registerEmail">
            <input type="submit" id="checkEmailBtn">
        </form>
    </div>
...
<form id="registerForm" action="register.do">
        <table>
            <tr>
                <td>아이디</td>
                <td><input type="text" id="id" name="id" required style="width:17.5vw">
                <div id="idCheckMsg" style="color:red;font-size:0.7rem;font-weight: bold"></div></td>
            </tr>
            <tr>
                <td>비밀번호</td>
                <td><input type="password" id="pw" name="pw" required style="width:17.5vw"></td>
            </tr>
            <tr>
                <td>비밀번호확인</td>
                <td><input type="password" id="pwCheck" name="pwCheck" required style="width:17.5vw">
                	<div id="checkPWMsg"></div>
                </td>
            </tr>
            <tr>
                <td>이름</td>
                <td><input type="text" id="name" name="name" required style="width:17.5vw"></td>
            </tr>
            <tr>
                <td>주민등록번호</td>
                <td><input type="text" id="regNumF" name="regNumF" required style="width:8vw"> 
                - <input type="password" id="regNumB" name="regNumB" required style="width:8vw"></td>
            </tr>
            <tr>
                <td>전화번호</td>
                <td><input type="text" id="phone" name="phone" required style="width:17.5vw"></td>
            </tr>
            <tr>
                <td>이메일</td>
                <td><input type="email" name="email" id="email" required style="width:17.5vw"></td>
            </tr>
            <tr>
                <td>주소</td>
                <td>
...
<input type="text" id="sample4_roadAddress" placeholder="도로명주소" style="width:17.5vw" required name="roadAddress">
<input type="text" id="sample4_jibunAddress" placeholder="지번주소" style="width:17.5vw" required name="dibunAddress">
<span id="guide" style="color:#999;display:none"></span>
<input type="text" id="sample4_detailAddress" placeholder="상세주소" style="width:17.5vw" required name="detailAddress">
<input type="text" id="sample4_extraAddress" placeholder="참고항목" style="width:17.5vw" required name="extraAddress">
                </td>
            </tr>
            <tr>
                <td colspan="2">
                    <input type="submit" value="회원가입" id="nextBtn3">
                </td>
            </tr>
        </table>
    </form>
	...
	<script src="./js/MemberRegister.js" type="text/javascript"></script>
<script>
        ...
        $.ajax({
            ...
            success: function(result) {
                if (result == 0) {
                    ...
                    $("#identificationBox").append(newForm);
                    ...
                    $("#emailIdentiBtn").on("click", function(event) {
                        ...
                        $.ajax({
                            ...
                            success: function(result) {
                                ...
                                if (result == 0) {
                                    $('#emailCheckMsg').html("인증성공");
                                    $('#nextBtn2').css({ "backgroundColor" : "red" });
                                } else {
